...
public final class DrawingPanel extends FileFilter
    implements ActionListener, MouseListener, MouseMotionListener, Runnable, WindowListener {
    ...
    */
    ...
    public DrawingPanel(int width, int height) {
        ...
        if (isGraphical()) {
            ...
            panel.addMouseListener(this);  // (jsun)
            
            // main window frame
            frame = new JFrame(TITLE);
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // handles orphaned threads upon exit (jsun)
    ...
    /* 
     * methods for MouseListener (jsun)
     */

	@Override
	public void mouseClicked(MouseEvent e) {
        mouseX = e.getX() / currentZoom;
        mouseY = e.getY() / currentZoom;
		mouseClicked = true;
	}
